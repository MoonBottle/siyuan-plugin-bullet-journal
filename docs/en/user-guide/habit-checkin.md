...
The Workbench is a desktop-only integrated workspace, and the habit view is one of the default workbench views. In the workbench, the habit view provides the same data and interactions as the Habit Check-in Dock, but displayed in a larger main area.
...
The habit view (viewType: `habit`) embeds the habit workspace into the workbench:
