...
| 场景 | 一句话说明 | 适合你如果... |
|---|---|---|
| 🗓️ **规划日程** | 日历、甘特图、四象限，周/月/日视图自由切换 | 想看清任务时间线 |
| 🎯 **专注执行** | 番茄钟 + 待办清单，从规划到执行一气呵成 | 需要专注做事 |
| ✅ **习惯养成** | 习惯打卡，追踪每日进展和连续天数 | 想培养新习惯 |
| 📁 **项目管理** | 三栏布局，多项目一目了然 | 手上多个项目在跑 |
| 🤖 **AI 加持** | AI 对话查任务、技能市场、企业微信机器人 | 想让 AI 分担琐事 |
| 🖥️ **定制工作台** | 拖拽组合你的驾驶舱 | 想要一站式面板 |
| 📱 **移动办公** | 专门为手机设计的独立界面 | 经常用手机记任务 |
...
**日历** — 月/周/日/列表四种视图，支持仅事项/仅任务切换和事项状态筛选。点击任意事件查看详情弹框，下钻导航从月→周→日逐层深入。
...
**待办** — 侧边栏展示今日及未来待办，事项卡片显示项目分组名，支持置顶、跳过、设置预计时间。点击事项跳转到笔记原文。
