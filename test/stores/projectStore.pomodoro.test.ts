...
const mkItemsWithSharedBlockId = (
  ...
  return configs.map((c) => {
    ...
    return mkItem(date, sharedBlockId, {
      ...rest,
    ...
    mockSql.mockResolvedValue([
      {
        ...
        name: 'custom-pomodoro-1',
        value: '25,2026-03-15 10:00:00~10:25:00 专注工作1',
      },
      {
        blockId: sharedBlockId,
        name: 'custom-pomodoro-2',
        value: '30,2026-03-16 14:00:00~14:30:00 专注工作2',
      },
    ])
  ...
  it('多日期事项：共享 pomodoros 包含所有日期的记录', async () => {
    ...
    mockSql.mockResolvedValue([
      ...
      },
      {
        blockId: sharedBlockId,
        name: 'custom-pomodoro-2',
        value: '20,2026-03-17 15:00:00~15:20:00 专注工作2',
      },
    ])
  ...
  it('单日期事项：专注记录正常合并', async () => {
    ...
    mockSql.mockResolvedValue([
      ...
      },
      {
        blockId,
        name: 'custom-pomodoro-2',
        value: '15,2026-03-15 14:00:00~14:15:00 专注工作2',
      },
    ])
    ...
    mockSql.mockResolvedValue([
      {
        blockId: 'block-id-1',
        name: 'custom-pomodoro-1',
        value: '25,2026-03-15 10:00:00~10:25:00 事项1的专注',
      },
      {
        blockId: 'block-id-2',
        name: 'custom-pomodoro-1',
        value: '30,2026-03-16 14:00:00~14:30:00 事项2的专注',
      },
    ])
    ...
    mockSql.mockResolvedValue([
      {
        ...
        name: 'custom-pomodoro-1',
        value: '25,2026-03-15 10:00:00~10:25:00 Task级别专注',
      },
    ])
    ...
    mockSql.mockResolvedValue([
      {
        blockId,
        name: 'my-pomodoro-1',
        value: '25,2026-03-15 10:00:00~10:25:00 自定义前缀',
      },
      {
        blockId,
        name: 'custom-pomodoro-1',
        value: '30,2026-03-15 11:00:00~11:30:00 错误前缀',
      },
    ])
