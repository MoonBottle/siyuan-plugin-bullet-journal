...
describe('focusPlanReview', () => {
  ...
  it('统计今日摘要时不重复累计同一 blockId 的预计', () => {
    const summary = buildDailyFocusPlanSummary([
      ...
      { itemId: 'item-2', blockId: 'same', date: '2026-05-13', estimatedMinutes: 70, actualMinutes: 50, itemStatus: 'pending' },
    ], '2026-05-13');
  ...
  it('blockId 为空时不按相同内容错误合并不同事项', () => {
    const summary = buildDailyFocusPlanSummary([
      { itemId: 'item-1', date: '2026-05-13', estimatedMinutes: 25, actualMinutes: 25, itemStatus: 'completed', itemContent: '整理资料' },
      { itemId: 'item-2', date: '2026-05-13', estimatedMinutes: 50, actualMinutes: 30, itemStatus: 'pending', itemContent: '整理资料' },
    ], '2026-05-13');
