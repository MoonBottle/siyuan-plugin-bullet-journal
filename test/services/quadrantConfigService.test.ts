...
describe('quadrantConfigService', () => {
  ...
  it('saves and normalizes config', async () => {
    ...
    const custom = {
      version: 1 as const,
      panels: [
        { id: 'q1' as const, title: 'Custom', rules: { priority: ['high'] } },
        { id: 'q2' as const, title: '重要不紧急', rules: { priority: ['medium'] } },
        { id: 'q3' as const, title: '紧急不重要', rules: { priority: ['low'] } },
        { id: 'q4' as const, title: '不重要不紧急', rules: { priority: ['none'] } },
      ],
    };
