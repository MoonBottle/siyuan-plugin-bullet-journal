...
export async function initRpcApi(): Promise<void> {
  const methods = [
    ...
    {
      name: 'registerTimer',
      handler: handleRegisterTimer,
      desc: '注册计时器',
    },
    {
      name: 'registerTimers',
      handler: handleRegisterTimers,
      desc: '批量注册计时器',
    },
    {
      name: 'cancelTimer',
      handler: handleCancelTimer,
      desc: '取消计时器',
    },
    {
      name: 'cancelTimersByType',
      handler: handleCancelTimersByType,
      desc: '按类型取消计时器',
    },
    {
      name: 'getActiveTimers',
      handler: handleGetActiveTimers,
      desc: '查询活跃计时器',
    },
    {
      name: 'diagnose',
