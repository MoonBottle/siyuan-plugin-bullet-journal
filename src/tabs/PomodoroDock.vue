<template>
  <div class="fn__flex-1 fn__flex-column pomodoro-dock">
    ...
    <PomodoroBreakOverlay
      :visible="pomodoroStore.isBreakOverlayVisible"
      @close="onBreakOverlayClose"
    />
  </div>
</template>
...
const unsubscribeBreakStarted: (() => void) | null = null
const unsubscribeBreakEnded: (() => void) | null = null
