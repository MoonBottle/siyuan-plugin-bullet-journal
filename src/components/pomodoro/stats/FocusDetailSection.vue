        ...
        >
          ...
          <div class="stats-item-bar">
            <div
              ...
              :style="{
                width: `${item.proportion}%`, backgroundColor: getColor(index),
              }"
            />
          </div>
        </div>
...
import type { GroupedPomodoroStats } from '@/utils/pomodoroUtils'
import {
  computed,
  ref,
} from 'vue'
...
const aggregateOptions = computed(() => [
  {
    label: t('pomodoroStats').byTask,
    value: 'task',
  },
  {
    label: t('pomodoroStats').byItem,
    value: 'item',
  },
])
...
const rangeOptions = computed(() => [
  {
    label: t('pomodoroStats').day,
    value: 'today',
  },
  {
    label: t('pomodoroStats').week,
    value: 'week',
  },
  {
    label: t('pomodoroStats').month,
    value: 'month',
  },
])
