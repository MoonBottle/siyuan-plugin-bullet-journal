<template>
  <div
    class="recurring-setting-dialog"
  ...
  >
    ...
    <!-- 每周指定周几 -->
    <div
      v-if="selectedRule === 'weekly'"
      class="custom-section"
    >
      <div class="weekday-label">
        {{ t('recurring.selectWeekDays') }}
      </div>
...
const weekDays = computed(() => [
  {
    value: 1,
    label: t('recurring.monday'),
  },
  {
    value: 2,
    label: t('recurring.tuesday'),
  },
  {
    value: 3,
    label: t('recurring.wednesday'),
  },
  {
    value: 4,
    label: t('recurring.thursday'),
  },
  {
    value: 5,
    label: t('recurring.friday'),
  },
  {
    value: 6,
    label: t('recurring.saturday'),
  },
  {
    value: 0,
    label: t('recurring.sunday'),
  },
])
// 根据事项日期获取默认周几（如果没有指定）
