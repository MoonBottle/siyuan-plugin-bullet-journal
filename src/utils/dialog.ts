...
export function showItemDetailModal(item: Item): Dialog {
  ...
  if (item.project) {
    content += `
      <div class="sy-dialog-card">
        <div class="sy-dialog-card-title"><span class="sy-dialog-icon b3-tooltips b3-tooltips__n" aria-label="项目">📁</span>项目</div>
  ...
  if (item.task) {
    ...
    content += `
      <div class="sy-dialog-card">
        <div class="sy-dialog-card-title"><span class="sy-dialog-icon b3-tooltips b3-tooltips__n" aria-label="任务">📝</span>任务</div>
        <div class="sy-dialog-card-content">
  ...
  content += `
    <div class="sy-dialog-card sy-dialog-item-card">
      <div class="sy-dialog-card-title"><span class="sy-dialog-icon b3-tooltips b3-tooltips__n" aria-label="事项">📋</span>事项</div>
